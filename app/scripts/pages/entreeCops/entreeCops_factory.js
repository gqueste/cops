    ...
    factory('EntreeCopsService', [function(){
        ...
        var entrees = {
            academie : {
                ...
                options : [
                    "Le personnage débute la partie avec 2 Points d’ancienneté et 0 Point d’adrénaline."
                ]
            },
            armee : {
                ...
                options : [
                    "Le personnage débute la partie avec 1 Point d’ancienneté et 1 Point d’adrénaline."
                ]
            },
            concours : {
            ...
            federale : {
                ...
                options : [
                    "Le personnage débute la partie avec 1 Point d’ancienneté et 1 Point d’adrénaline",
                    "2 Points d’ancienneté et 0 Point d’adrénaline"
                ]
            },
            sportif : {
                nom : "Sportif",
                ...
                options : [
                    "Le personnage débute la partie avec 0 Point d’ancienneté et 2 Points d’adrénaline"
                ]
            },
            piston : {
                nom : "Piston",
            ...
            exotique : {
                ...
                options : [
                    "Le personnage débute la partie avec 2 Points à répartir entre ancienneté et adrénaline"
                ]
            }
        };

        var entreeSelectionnee = undefined;
